...
def main() -> None:
    ...
    for c in c_values:
        for gamma in gamma_values:
            for cw in class_weights:
                ...
                print(f"Training RBF SVC with C={c}, gamma={gamma}, class_weight={cw}")
                ...
                for thr in thresholds:
                    ...
                    print(
                        f"  threshold={thr}, trades={val_metrics['trades_taken']}, "
    ...
    output_path = "././docs/Zhongjie_Results/rbf_svm_validation_results.csv"
